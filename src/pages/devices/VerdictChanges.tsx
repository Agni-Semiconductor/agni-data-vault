...
export default function VerdictChanges() {
  ...
  return <div className="space-y-4">
     <header className="max-w-3xl"><p className="label-caps text-agni-orange">Device evidence</p><h1 className="mt-1 text-xl font-semibold">Verdict changes</h1><p className="mt-2 text-sm text-agni-slate">Cross-run changes for exact bench cells. Device links use only identities returned by the vault; addresses are never joined across schemes by prefix.</p></header>
     <div className="max-w-3xl flex flex-wrap items-end gap-3 rounded-lg border border-border-subtle bg-white p-4">
