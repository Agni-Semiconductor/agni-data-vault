insert into public.option_lists (key, label, description) values
...
insert into public.option_values (list_key, value, label, sort_order) values
...
insert into public.allowlist (email, role) values ('spencer.ware@agnisemi.ai', 'admin') on conflict (email) do nothing;
